...
VERSION=$(curl -s https://api.github.com/repos/humancto/homebrew-mozzy/releases/latest | grep '"tag_name":' | sed -E 's/.*"v([^"]+)".*/\1/')
...
URL="https://github.com/humancto/homebrew-mozzy/releases/download/v${VERSION}/mozzy_${VERSION}_${PLATFORM}.tar.gz"
